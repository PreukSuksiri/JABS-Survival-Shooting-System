...
J.ABS.Metadata.DefaultDodgeSkillTypeId = 1;//Number(J.ABS.PluginParameters['Default Dodge Skill Type Id']);
J.ABS.Metadata.DefaultGuardSkillTypeId = 2;//Number(J.ABS.PluginParameters['Default Guard Skill Type Id']);
