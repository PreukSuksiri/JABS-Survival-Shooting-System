 ...
 * @default true
 *
 * @param Show pop up damage
 * @type boolean
 * @desc Show pop-up damage
 * @default true
 *
 ...
 * @text Force-assign a JABS skill to a key
 * @desc Forcefully assigns a specific skill id to a designated slot.
 * @arg Id
 * @type number
 * @default 1
 * @arg Slot
 ...
 * @text Force-assign a JABS common event to a key
 * @desc Forcefully assigns a specific common event id to a designated slot.
 * @arg Id
 * @type number
 * @default 1
 * @arg Slot
...
J.ABS.Metadata.DefaultDodgeSkillTypeId = 1;
J.ABS.Metadata.DefaultGuardSkillTypeId = 2;
J.ABS.Metadata.DefaultToolCooldownTime = 300;
 ...
 */
  ...
  switch (slot) {
	case "1": return Game_Actor.JABS_NUM1_SKILL;
	case "2": return Game_Actor.JABS_NUM2_SKILL;
	case "3": return Game_Actor.JABS_NUM3_SKILL;
	case "4": return Game_Actor.JABS_NUM4_SKILL;
	case "5": return Game_Actor.JABS_NUM5_SKILL;
	case "6": return Game_Actor.JABS_NUM6_SKILL;
	case "7": return Game_Actor.JABS_NUM7_SKILL;
	case "8": return Game_Actor.JABS_NUM8_SKILL;
	case "9": return Game_Actor.JABS_NUM9_SKILL;
	case "0": return Game_Actor.JABS_NUM0_SKILL;
	case "-": return Game_Actor.JABS_NUMMINUS_SKILL;
	case "=": return Game_Actor.JABS_NUMEQUAL_SKILL;
	case "TAB": return Game_Actor.JABS_TAB_SKILL;
  };
};
...
/**
 * Plugin command for assigning a common event to a designated key.
 */
PluginManager.registerCommand(J.ABS.Metadata.Name, "Set JABS Common Event", args => {
  const { Id, Slot } = args;
  if (String(Slot) == "1")
  {
	  $gamePlayer.COMMONEVENT_NUM1 = Number(Id);
	  
  }
  if (String(Slot) == "2")
  {
	  $gamePlayer.COMMONEVENT_NUM2 = Number(Id);
	  
  }
  if (String(Slot) == "3")
  {
	  $gamePlayer.COMMONEVENT_NUM3 = Number(Id);
	  
  }
  if (String(Slot) == "4")
  {
	  $gamePlayer.COMMONEVENT_NUM4 = Number(Id);
	  
  }
  if (String(Slot) == "5")
  {
	  $gamePlayer.COMMONEVENT_NUM5 = Number(Id);
	  
  }
  if (String(Slot) == "6")
  {
	  $gamePlayer.COMMONEVENT_NUM6 = Number(Id);
	  
  }
  if (String(Slot) == "7")
  {
	  $gamePlayer.COMMONEVENT_NUM7 = Number(Id);
	  
  }
  if (String(Slot) == "8")
  {
	  $gamePlayer.COMMONEVENT_NUM8 = Number(Id);
	  
  }
  if (String(Slot) == "9")
  {
	  $gamePlayer.COMMONEVENT_NUM9 = Number(Id);
	  
  }
  if (String(Slot) == "0")
  {
	  $gamePlayer.COMMONEVENT_NUM0 = Number(Id);
	  
  }
  if (String(Slot) == "-")
  {
	  $gamePlayer.COMMONEVENT_NUMMINUS = Number(Id);
	  
  }
  if (String(Slot) == "=")
  {
	  $gamePlayer.COMMONEVENT_NUMEQUAL = Number(Id);
	  
  }
  if (String(Slot) == "Tab")
  {
	  $gamePlayer.COMMONEVENT_TAB = Number(Id);
...
/**
 * Plugin command for cycling through party members.
 */
PluginManager.registerCommand(J.ABS.Metadata.Name, "Rotate Party Members", () => {
  $gameBattleMap.rotatePartyMembers();
});
...
J.ABS.Input.Num9 = "9";
J.ABS.Input.Num0 = "0";
J.ABS.Input.NumMinus = "-";
J.ABS.Input.NumEqual = "=";
...
Input.keyMapper = {
  ...
  90: J.ABS.Input.A,          // z
  88: J.ABS.Input.B,          // x		
  403: J.ABS.Input.X,          // shift
  405: J.ABS.Input.Y,          // leftcontrol
  9: J.ABS.Input.Tab,         // tab
...
Game_Actor.JABS_TAB_SKILL = "TAB";
Game_Actor.JABS_NUM1_SKILL = "Num1";
Game_Actor.JABS_NUM2_SKILL = "Num2";
Game_Actor.JABS_NUM3_SKILL = "Num3";
Game_Actor.JABS_NUM4_SKILL = "Num4";
Game_Actor.JABS_NUM5_SKILL = "Num5";
Game_Actor.JABS_NUM6_SKILL = "Num6";
Game_Actor.JABS_NUM7_SKILL = "Num7";
 ...
 */
  ...
  this._j._equippedSkills[Game_Actor.JABS_NUM1_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM2_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM3_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM4_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM5_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM6_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM7_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM8_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM9_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUM0_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUMMINUS_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_NUMEQUAL_SKILL] = { id: 0, locked: false, };
  this._j._equippedSkills[Game_Actor.JABS_TAB_SKILL] = { id: 0, locked: false, };
 ...
 * @param {number?} newSpeed If provided, will set this event's movespeed to this.
 */
Game_Event.prototype.setCustomMoveSpeed = function(newSpeed = null) {
...
if (this.toggleHud != null)
{
	 this.toggleHud(true);
}
if (this.toggleLog != null)
{
	this.toggleLog(true);
}
...
Sprite_Character.prototype.configurePopup = function(popup) {
  ...
  switch (popup.getType()) {
    case "damage":
      sprite._xVariance = getRandomNumber(-30, 30) +100;
      sprite._yVariance = getRandomNumber(-30, 30);
	  if (J.ABS.Metadata.ShowPopupDamage)
	  {
		 this.buildDamagePopSprite(sprite, popup); 
		  if (popup.getIcon() >  0 && J.ABS.Metadata.ShowPopUpSkillIcon) {
 ...
 */
Sprite_Damage.prototype.addIcon = function(iconIndex,xOffset) {
...
class Game_BattleMap {
  ...
  handleAbsInput() {
    ...
    if (Input.isTriggered(J.ABS.Input.Num1)) {
      this.performSkillAction(1);
	  
	  if ($gamePlayer.COMMONEVENT_NUM1 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM1);
	  }
	  
      return;
    }
    if (Input.isTriggered(J.ABS.Input.Num2)) {
      this.performSkillAction(2);
	  if ($gamePlayer.COMMONEVENT_NUM2 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM2);
	  }
      return;
    }
    if (Input.isTriggered(J.ABS.Input.Num3)) {
      this.performSkillAction(3);
	  if ($gamePlayer.COMMONEVENT_NUM3 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM3);
	  }
      return;
    }
    if (Input.isTriggered(J.ABS.Input.Num4)) {
      this.performSkillAction(4);
	  if ($gamePlayer.COMMONEVENT_NUM4 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM4);
	  }
      return;
    }
    if (Input.isTriggered(J.ABS.Input.Num5)) {
      this.performSkillAction(5);
	  if ($gamePlayer.COMMONEVENT_NUM5 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM5);
	  }
      return;
    }
    if (Input.isTriggered(J.ABS.Input.Num6)) {
      this.performSkillAction(6);
	  if ($gamePlayer.COMMONEVENT_NUM6 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM6);
	  }
      return;
    }
    if (Input.isTriggered(J.ABS.Input.Num7)) {
      this.performSkillAction(7);
	  if ($gamePlayer.COMMONEVENT_NUM7 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM7);
	  }
      return;
    }
    if (Input.isTriggered(J.ABS.Input.Num8)) {
      this.performSkillAction(8);
	  if ($gamePlayer.COMMONEVENT_NUM8 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM8);
	  }
      return;
    }
	
	if (Input.isTriggered(J.ABS.Input.Num9)) {
      this.performSkillAction(9);
	  if ($gamePlayer.COMMONEVENT_NUM9 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM9);
	  }
      return;
    }
	
	if (Input.isTriggered(J.ABS.Input.Num0)) {
      this.performSkillAction(10);
	  if ($gamePlayer.COMMONEVENT_NUM0 != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUM0);
	  }
      return;
    }
	
	if (Input.isTriggered(J.ABS.Input.NumMinus)) {
      this.performSkillAction(11);
	  if ($gamePlayer.COMMONEVENT_NUMMINUS != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUMMINUS);
	  }
      return;
    }
	
	if (Input.isTriggered(J.ABS.Input.NumEqual)) {
		this.performSkillAction(12);
		if ($gamePlayer.COMMONEVENT_NUMEQUAL != null)
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_NUMEQUAL);
	  }
...
if (Input.isTriggered(J.ABS.Input.TAB)) {
	  ...
	  {
		  $gameTemp.reserveCommonEvent($gamePlayer.COMMONEVENT_TAB);
	  }
      return;
    }
  ...
  performSkillAction(inputCombo) {
   ...
   let mapActions = [];
    switch (inputCombo) {
      case 1: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM1_SKILL);
        break;
      case 2:
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM2_SKILL);
        break;
      case 3:
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM3_SKILL);
        break;
      case 4: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM4_SKILL);
        break;
      case 5: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM5_SKILL);
        break;
      case 6: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM6_SKILL);
        break;
      case 7: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM7_SKILL);
        break;
      case 8: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM8_SKILL);
        break;
	  case 9: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM9_SKILL);
        break;
	  case 10:
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUM0_SKILL);
        break;
	  case 11: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUMMINUS_SKILL);
        break;
	  case 12: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_NUMEQUAL_SKILL);
        break;
	  case 13: 
        mapActions = this.getSkillActionData(battler, Game_Actor.JABS_TAB_SKILL);
        break;
    }
...
//console.log($dataMap.events.length);
    ...
    if (!actionEventData || !actionEventData.pages.length) return;
 ...
 */
JABS_Battler.prototype.executeDodgeSkill = function() {
  const battler = this.getBattler();
  ...
  if (canPay && skill._j.moveType) {
    ...
    console.error("not enough resources or dodge skill setup incorrectly.");
    return;
  }
};
 ...
 */
JABS_Battler.prototype.createMapActionFromSkill = function(skillId, isRetaliation = false, cooldownKey = null) {
  const battler = this.getBattler();
  const skill = $dataSkills[skillId];
  const action = new Game_Action(battler);
  action.setSkill(skill.id);

  let { cooldown, range, actionId, duration, shape, piercing, projectile, proximity } = skill._j;
...
JABS_Battler.prototype.countdownAnimation = function() {
  ...
  if (this._animationFrames > 0) {
    ...
    if (this._animationFrames < 4) {
      //this.getCharacter()._pattern = 0; //Mysticphoenix Edited 04-MAR-2021
    } else if (this._animationFrames > 10) {
      //this.getCharacter()._pattern = 2; //Mysticphoenix Edited 04-MAR-2021
    } else {
      //this.getCharacter()._pattern = 1; //Mysticphoenix Edited 04-MAR-2021
    }
  } else {
    this.resetAnimation();
  }
 ...
 */
JABS_Battler.prototype.parseAi = function() {
  const character = this.getCharacter();
 ...
 * @returns {JABS_BattlerAI} The AI built off the provided attributes.
 */
JABS_Battler.prototype.translateAiCode = function(code) {
